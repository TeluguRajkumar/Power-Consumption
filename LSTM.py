...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov  2 18:01:26 2021
...
#### load dataset #######
df = pd.read_csv("/Users/rajkumar/Desktop/AC_Data.csv")

# for c in df.columns:
#   print(c)

df = df.drop(['AC 1', 'AC 2', 'AC3', 'AC 4', 'AC 5', 'AC 6', 'AC 7', 'AC 8', 'AC 9', 'AC 10', 'AC 11', 'AC 12', 'AC 13', 'AC 14', 'AC 15', 'AC 16', 'AC 17', 'AC 18'], axis=1)
...
factor = 3
upper_lim = df['AC 1'].mean () + df['AC 2'].std () * factor
lower_lim = df['AC 1'].mean () - df['AC 2'].std () * factor
df = df[(df['AC 1'] < upper_lim) & (df['AC 2'] > lower_lim)]
...
for index,value in enumerate(times):
  if(value > '2007-08-08' and value <'2007-09-01'):
    ...
    temp.append(float(df['AC 1'][index]))
...
df['future'] = df["AC 1"].shift(-FUTURE_PERIOD_PREDICT)
df.dropna(inplace=True)

print(df[['AC 1','future']].head(10))
...
### performance metrics forward validation
